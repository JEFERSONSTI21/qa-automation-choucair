...
public class QuestionContaints implements ICommand<Consequence> {
     ...
     */
    public QuestionContaints(String equalsToString) {
    ...
    public Consequence Execute(IParam params) {
        ...
        return seeThat(param.targetElementName, question, containsString(equalsToString));
